...
#[structopt(
    ...
    about = "Read and update Vouch configuration.",
    after_help = "Examples:\n    vouch config get\n    vouch config get core.api-base\n    vouch config set review-tool.agent claude"
)]
...
pub enum Subcommand {
    ...
    #[structopt(
        ...
        after_help = "Examples:\n    vouch config get\n    vouch config get review-tool.agent"
    )]
    Get(GetArguments),
    ...
    #[structopt(
        ...
        after_help = "Example:\n    vouch config set review-tool.agent codex"
    )]
    Set(SetArguments),
}
